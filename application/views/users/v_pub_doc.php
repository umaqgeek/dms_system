<div class="row">
    <div class="col-md-12">
        ...
        <center><h3>Public Documents</h3></center>
        
        <button type="button" class="btn btn-success" 
                onclick="location.href='<?=site_url('users/publicDocument/add'); ?>';"> Add Document </button>
        <br />
        <br />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if ($u_id_file == $u_id_sess) {
                            ...
                            ?>
                        <a onclick="return ask('Are you sure to delete this?');" href="<?=site_url('users/publicDocument_delete/'.$d_idx); ?>">
                            <span class="fa fa-remove"></span>
                        </a>
                        &nbsp;
                        <a onclick="return ask('Are you sure to private this?');" href="<?=site_url('users/changeDocument/2/'.$d_idx); ?>">
