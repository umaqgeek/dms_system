<div class="row">
    <div class="col-md-12">
        ...
        <center>
            <h3>Add Public Document</h3>
        </center>
        
        <button type="button" class="btn btn-info" 
                onclick="location.href='<?=site_url('users/publicDocument'); ?>';"> Back </button>
        <br />
        <br />
        
        <form method="post" action="<?=site_url('users/publicDocument_process'); ?>" enctype="multipart/form-data">
            <table class="table">
                <tr>
                    <th>File Name</th>
                    <th>:</th>
